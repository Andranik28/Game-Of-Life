...
names = [["grass","grassEater","gishatich","creater","amenaker"],["count","created","died","multiplyed","eated","wasEaten"]];
...
io.on('connection', function (socket) {
    function drawServerayin() {
        ...
        for (var i in gishatichArr) {
            if(season != 2){ 
                gishatichArr[i].utel(1);
            }
            else{
            gishatichArr[i].utel(0);
        ...
        for (var i in createrArr) {
            ...
            if (season == 1){
            createrArr[i].mahanal(1);}
            else{ createrArr[i].mahanal(0);}
        }
